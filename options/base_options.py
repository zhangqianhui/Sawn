...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--which_iter', type=str, default='1158000', help='which iterations to load')
        parser.add_argument('--gpu_ids', type=str, default='0, 1, 2, 3', help='gpu ids: e.g. 0, 1, 2 use -1 for CPU')
        parser.add_argument('--phase', type=str, default='train', help='train, val, test, etc')
        parser.add_argument('--continue_train', action='store_true', help='continue training: load the latest model')
        parser.add_argument('--is_texturet', action='store_true', help='texture transfer')
        parser.add_argument('--seg_label', type=int, default=4, help='which label for style transfer')
        parser.add_argument('--iswarped', action='store_true', help='is flow')
        parser.add_argument('--isFig', action='store_true', help='is for Fig')

        # input/output sizes
        parser.add_argument('--batchSize', type=int, default=8, help='input batch size')
        parser.add_argument('--old_size', type=int, default=(512,512), help='Scale images to this size. The final image will be cropped to --crop_size.')
        ...
        parser.add_argument('--dirSem', required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
