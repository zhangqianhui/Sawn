...
class FlowNet(BaseModel):
    ...
    def modify_options(parser, is_train=True):
        ...
        parser.add_argument('--netG', type=str, default='flownet', help='The name of net Generator')
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            self.Correctness = PerceptualCorrectness().to(opt.device)
            self.Regularization = MultiAffineRegularizationLoss(kz_dic=opt.kernel_size).to(opt.device)
